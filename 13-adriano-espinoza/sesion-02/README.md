...
Separación de Hardware y Software: El hardware era el telar físico; el software eran las tarjetas. Para cambiar el diseño de la tela no se alteraba la máquina, solo las tarjetas.
Sistema Binario Primitivo: Lógica binaria basada en la presencia/ausencia de materia.
...
El Píxel y la Imagen Rasterizada: El tejido funciona como un mapa de bits; la tela es la rejilla de soporte (grid) y cada intersección de hilos opera como un píxel individual regulado por la tarjeta perforada.
